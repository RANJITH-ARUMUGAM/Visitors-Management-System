...
const AddNewMaterialMovement = ({ setTitle }) => {
    ...
    useEffect(() => {
        setTitle("Add Material Movement");
        fetchVehicleLogs();
    }, []);
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.post(`${SERVER_PORT}/AddNewmaterial-movement`, {
            ...
            alert("Failed to add material movement");
        }
    };

    return (
        <div className="min-h-screen bg-gray-100">
            <h2 className="text-xl font-semibold mb-2 text-gray-800 text-center rounded-xl shadow mt-4">Add Material Movement</h2>
...
export default AddNewMaterialMovement;