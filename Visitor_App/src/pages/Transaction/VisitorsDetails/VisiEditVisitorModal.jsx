...
export function VisiEditVisitorModal({ isOpen, onClose, onSubmit, visitor }) {
  ...
  useEffect(() => {
    if (visitor) {
      setFormData({
        ...
        hostPerson: visitor.hostPerson || '',
        status: visitor.status || 'pre-booked',
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="w-full max-w-3xl max-h-[90vh] overflow-y-auto bg-white border-0 shadow-2xl rounded-2xl">
        {/* Header */}
        <div className="border-b border-slate-200 p-6 pb-4 bg-gradient-to-r from-emerald-50 to-green-50">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-2xl font-bold text-slate-900">Edit Visitor</h2>
        ...
        <div className="p-6">
          <form onSubmit={handleSubmit} className="space-y-6">
            {/* Avatar Section */}
            <div className="flex items-center gap-4 p-4 rounded-xl bg-gradient-to-r from-emerald-50 via-green-50 to-teal-50 border border-emerald-200">
              <div className="relative">
                <div className="w-20 h-20 rounded-full bg-gradient-to-br from-emerald-400 to-green-600 flex items-center justify-center text-white text-2xl font-bold shadow-lg">
                  {formData.imageUrl ? (
              ...
              <button
                ...
                className="inline-flex items-center px-4 py-2 text-sm font-medium text-emerald-600 bg-white border border-emerald-200 rounded-lg hover:bg-emerald-50 hover:text-emerald-700 transition-colors shadow-sm"
              >
            ...
            <div className="flex justify-end gap-3 pt-6 border-t border-slate-200">
              ...
              <button
                type="submit"
                className="px-6 py-2.5 text-sm font-medium text-white bg-gradient-to-r from-emerald-600 to-green-600 border-0 rounded-lg hover:from-emerald-700 hover:to-green-700 transition-all shadow-lg hover:shadow-xl"
              >
